...
%\heading{Day Level Carbohydrate Eating Patterns}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=30cm]{Fig/Fig01a.png}
...
%  \begin{block}{Day Level Carbohydrate Eating Patterns}
	...
	\begin{figure}
		\centering
		\includegraphics[width=33cm]{Fig/Fig01b.png}	\vskip-2.45ex
		\caption{Day level latent class solutions (Classes 1-3 days).}
	\end{figure}
