...
\vskip-2.45ex
  \begin{block}{Individual Level Latent Class Solution}
	...
	\begin{figure}
	\centering
	\includegraphics[width=27cm]{Fig/level2.eps}	\vskip-2.45ex
	\caption{Multilevel Latent Class Solution, 3 classes in day level, 3 classes in individual level.}\vskip-2.45ex
\end{figure}
...
\heading{Nutrient Contributions to Energy within the Time Slots}
  \begin{block}{}
	%\heading{Day Level Carbohydrate Eating Patterns}
	\vskip-2.45ex
	\begin{figure}
		...
		\includegraphics[width=40cm]{Fig/compo.eps}
		      \caption{The compositions of energy consumption within each time slot by CH eaters.}
	\end{figure}
\end{block}
